...
[State University of New York at Albany](https://www.albany.edu/). Our research focuses on understanding the processes governing greenhouse gases and air pollutants.

- **Leverage Next-Generation Satellites**  
  We utilize data from cutting-edge satellite missions. As the volume of new observations explodes, advancing the state of inverse methodology is crucial for full exploitation of these data. We integrate these satellite data with machine learning and data assimilation, enabling more accurate, scalable, and robust inference of geophysical state variables.
